...
button = tk.Button(buttonFrame, text = 'Search', bg = '#2FA170', font = ('Times New Roman', 20), command = lambda: get_article(entry.get()))
...
label = tk.Label(second_frame, font = ('Times New Roman', 17,), bg = '#C4C7E3', cursor = 'hand2', wraplength = 300, anchor = 'center')
